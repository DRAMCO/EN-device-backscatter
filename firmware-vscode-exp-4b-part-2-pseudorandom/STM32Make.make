...
# target
######################################
TARGET = firmware-vscode-exp-4b-part-2-pseudorandom-f4
...
GCC_PATH="C:/ST/STM32CUBECLT_1.15.1/GNU-TOOLS-FOR-STM32/BIN
ifdef GCC_PATH
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"C:/ST/OPENOCD-20231002-0.12.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"C:/ST/OPENOCD-20231002-0.12.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32l0 mass_erase 0; exit"
